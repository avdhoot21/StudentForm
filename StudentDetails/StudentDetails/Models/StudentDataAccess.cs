...
namespace StudentDetails.Models
{
    public class StudentDataAccess
    {
        ...
        /// Gets the Students
        /// </summary>
        /// <param name="studentDTO">Uses StudentDTO to GetStudents</param>
        ...
        {
            studentDTO.Students = new List<StudentModel>();
            studentDTO.SearchStudents = studentDTO.SearchStudents;
            return _students.FindAll(Student => Student.FirstName.ToLower().Contains(studentDTO.SearchStudents) || Student.FirstName.Contains(studentDTO.SearchStudents) ||
              Student.LastName.Contains(studentDTO.SearchStudents) || Student.LastName.ToLower().Contains(studentDTO.SearchStudents) ||
              Student.Age.ToString().Contains(studentDTO.SearchStudents)).
